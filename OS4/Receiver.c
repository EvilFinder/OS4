...
int main()
{
	...
	for (int i = 0; i < sendersCount; i++) {
		char senderFullName[500] = "Sender.exe ";
		char messages[10];
		itoa(binFileMessagesCount, messages, 10);
		strcat(senderFullName, binFileName);
		strcat(senderFullName, " ");
		strcat(senderFullName, messages);
